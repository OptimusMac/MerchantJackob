            ...
            <div class="collapse navbar-collapse navbar-collapse-overlay" id="navbar-main-collapse">
                ...
                <ul class="navbar-nav ml-lg-auto">
                    {{-- <li class="nav-item  dropdown dropdown-animate" data-toggle="hover">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Активные сервера</a>
                            ...
                            <div class="list-group list-group-flush px-lg-4">
                                <a href="#" class="list-group-item list-group-item-action" role="button">
                                    <div class="d-flex">
                                        <!-- Media body -->
                                        <div>
                                            <h6 class="heading mb-0">Активные сервера</h6>
                    ...
                    <li class="nav-item  d-lg-block ">
                        <a class="nav-link text-warning" href="https://donate.mia-mine.online">
